...
class FactorPool:
    ...
    def _init_default_factors(self):
        ...
        self.factors.extend([
            ...
            PriceFactor('relative_strength', '相对强度', 'price', 'higher_better', 0.5, min_value=0, max_value=1),
        ...
        self.factors.extend([
            ...
            FundamentalFactor('roe', '净资产收益率', 'fundamental', 'higher_better', 0.10, min_value=0, max_value=1),
        ])
